...
public class industrial_visit_update extends HttpServlet
{
  public void service(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
  {
	...
	try
    {
		...
		rs_date = stmt_date.executeQuery("SELECT Visited_Date FROM Student_Local_Industrial_Visits where Years="+year+" order by Local_Industries_ID desc");
	...
	//table head code
		...
		out.print("<body><form action='industrial_update_save' target='_self'><table class='table table-hover' id='data'><thead><div class='row'><tr class='table100-head theadrow'>");		
		...
		while(rs.next())
		{
			...
			if(req.getParameter(String.valueOf(rs.getInt(5)))!=null)
			{
				...
				out.print("<td><center><button type='submit' class='btn btn-primary' name='update' value='"+rs.getString(5)+"'>Update</button></center></td></tr>");			
