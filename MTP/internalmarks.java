...
public class internalmarks extends HttpServlet
{
  public void service(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
  {
	...
	try
    {
		...
		out.print("<body>");
		out.print("<form action='internalmarks' name='' target='_self'>");
		...
		if(req.getParameter("update")!=null)
		{
			...
			while(subject_code.next())
			{
				insert_stmt.executeUpdate("UPDATE Internal_Marks SET Marks = '"+req.getParameter(subject_code.getString(1))+"' where Years="+year+" and Semester="+semester+" and Types='"+update_exam_type+"' and Student_Code='"+roll_no+"' and SubjectName='"+subject_code.getString(1)+"';");
			}
		}
