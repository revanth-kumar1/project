  ...
  public void service(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
  {
	...
	try
    {
		...
		if(req.getParameter("save")!=null)
		{
			...
			String sql2 = "SELECT List_Of_Industries_Visited,convert(varchar,Visited_Date,105),Learning_Points,Action_Plan,Outstation_Tech_Visits_ID FROM Student_Outstation_Tech_Visits where Years="+year+" and Student_Code='"+roll_no+"' order by Outstation_Tech_Visits_ID desc";
			...
			out.print("<body><form action='outstation_update' target='_self'><table class='table table-hover' id='data'><thead><div class='row'><tr class='table100-head theadrow'>");
		...
		else if(req.getParameter("update")!=null)
		{
			...
			stmt.executeUpdate("UPDATE Student_Outstation_Tech_Visits SET List_Of_Industries_Visited = '"+nameoftheindustryvisited+"',Visited_Date='"+dateofvisit+"',Learning_Points = '"+learningpoints+"',Action_Plan = '"+actionplan+"' WHERE Outstation_Tech_Visits_ID = '"+row_id+"' ;");
		...
		else if(req.getParameter("search")!=null)
		{
			...
			if(rs.isBeforeFirst())
			{
				...
				while(rs.next())
				{	
					out.print("<tr class='tbodyrow'><div class='col-sm-3'><td><textarea rows='5' cols='25' disabled>"+rs.getString(1)+"</textarea></td><div class='col-sm-3'><td><p>"+rs.getString(2)+"</p></td></div><div class='col-sm-3'><td><textarea rows='5' cols='35' disabled>"+rs.getString(3)+"</textarea></td></div><div class='col-sm-3'><td><textarea rows='5' cols='35' disabled>"+rs.getString(4)+"</textarea></td></div><div class='col-sm-1'><td><button type='submit' name='"+rs.getInt(5)+"' class='btn btn-primary'>Edit</button></td></div></tr>");			
